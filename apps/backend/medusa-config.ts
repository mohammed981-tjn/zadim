...
export default defineConfig({
  ...
  modules: [
    ...
    // دفترُ القيود (البند ١٫٣) — **وبندان ينتظرانه**: رصيدُ المتجر بدل
    // النقد، وتقاريرُ الهامش. والأرقامُ قبله كانت تُشتقّ من المجاميع،
    // فلا سجلَّ يُحتكم إليه حين تختلف.
    //
    // 🔴 وتوازنُه **خاصّةُ القاعدة** لا عادةُ كود: قيدُ مُطلِقٍ مؤجَّلٌ
    // إلى COMMIT يرفض نصفَ قيدٍ التُزم به — من أيّ مسارٍ كان.
